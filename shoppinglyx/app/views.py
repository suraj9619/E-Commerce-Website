...
def mobile(request, data=None):
 if data == None:
  mobiles = Product.objects.filter(category='M')
 elif data == 'Oneplus' or data == 'Oppo':
...
def topwears(request, data=None):
 if data == None:
  ...
  topwears = Product.objects.filter(category='TW').filter(discounted_price__lt=150)
 elif data == 'above':
  topwears = Product.objects.filter(category='TW').filter(discounted_price__gt=150)
 return render(request, 'app/topwares.html', {'topwears':topwears})

def bottomwears(request, data=None):
 if data == None:
  bottomwears = Product.objects.filter(category='BW')
 elif data == 'bottomwears':
